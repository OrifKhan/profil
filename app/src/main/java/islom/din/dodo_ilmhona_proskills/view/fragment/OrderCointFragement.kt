...
import islom.din.dodo_ilmhona_proskills.databinding.FragmentOrderCointFragementBinding
import islom.din.dodo_ilmhona_proskills.view.adapter.CoinOderAdapter
...
class OrderCointFragement : Fragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() = OrderCointFragement()
    }
}